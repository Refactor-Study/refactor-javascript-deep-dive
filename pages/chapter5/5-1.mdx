...
<Tabs items={['1. 초기 상태', '2. Global Context', '3. outer Context', '4. outer Context GC', '5. inner Context', '6. 가비지 컬렉팅 1', '7. 가비지 컬렉팅 2']}>
  ...
  <Tabs.Tab>
    ![context_global_2_1](/images/chapter5/context_global_2_1.png) <br/>
  </Tabs.Tab>

  <Tabs.Tab>
    ![context_outer_2_1](/images/chapter5/context_outer_2_1.png) <br/>
  </Tabs.Tab>

  <Tabs.Tab>
    ![context_outer_2_2](/images/chapter5/context_outer_2_2.png) <br/>
  </Tabs.Tab>

  <Tabs.Tab>
    ![context_inner_2_1](/images/chapter5/context_inner_2_1.png) <br/>
  </Tabs.Tab>

  <Tabs.Tab>
    ![context_outer_2_3](/images/chapter5/context_outer_2_3.png) <br/>
  </Tabs.Tab>
